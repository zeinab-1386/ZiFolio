...
<head>
  ...
  <link rel="icon" href="/img/zizi.logo.png">
...
<body>
  ...
  <div class="menu">
    <a href="#home" data-key="header.home">Home</a>
    <a href="#About" data-key="header.about">About</a>
    <a href="#Services" data-key="header.services">Services</a>
  ...
  <div class="box">
      ...
      <!-- <div class="theme-toggle" onclick="toggleTheme()">
        ...
        <button class="contact-btn" id="contactBtn data-key="header.callMe" onclick="callNow()" >Call Me !</button>
  </div>
  ...
  <div class="home" id="home">
    ...
    <div class="content" >
      <h1 data-key="hero.title">Hi ! Im <span class="name">Zeianb</span></h1>
      <p data-key="hero.subtitle">Transforming digital experiences with dynamic design, powerful code, and a focus on performance and optimization.</p>
      
      <div class="link">
            <a href="https://github.com/zeinab-1386">
            ...
            <a href="https://t.me/z_gh_developer">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.instagram.com/z.gharib86/">
      ...
      <div class="person">
        <div class="container">
          <div class="container-inner">
            <img class="circle" />
            <img class="img img3" src="/img/avartar.png" width="10%"/>
          </div>
        </div>
      </div>
...
<section class="slider-section no-rtl" id="Services" >
  ...
  <div class="slider">
    <div class="slides">
      <div class="slide">
        <img src="/img/p1.jpg" alt="Project 1" width="100%" height="50% "/>
        ...
        <a href="../tikiShop/index.html" class="linka" data-key="slider.slides.0.link">Read More...</a>
      </div>
      <div class="slide">
        <img src="/img/2.jpg" alt="Project 2" width="100%"  height="50% "/>
        <div class="caption" data-key="slider.slides.1.caption">
        Lorem, ipsum dolor sit amet consectetur  <br>
          adipisicing elit. Ea culpa vel in sapiente omnis rb
          <br>repellendus magni? Beatae natus veritatis molestiae?<br>
        </div>
        <a href="/project.php" class="linka" data-key="slider.slides.1.link">Read More...</a>
      </div>
      <div class="slide">
        <img src="/img/3.jpg" alt="Project 3" width="100%"  height="50% "/>
        ...
        <a href="/project.php" class="linka" ata-key="slider.slides.2.link">Read More...</a>
      </div>
    </div>
    <div class="dots"></div>
  </div>
...
<!-- فقط قسمت Contact Section -->
<section class="contact-section" id="Contact">
  <div class="contact-wrapper">
    <div class="contact-left">
      <h1 data-key="contact.title">Contact Me</h1>
      <p data-key="contact.description">I'd love to hear from you ! Whether you have a question, a project, or just want to say hi — feel free to reach out using this form.</p>
    </div>
...
<footer class="site-footer">
  <div class="footer-container">
    <div class="footer-brand">
      <h2 data-key="footer.brandName">ZiZi</h2>
  ...
  <div class="footer-bottom">
    <p data-key="footer.copy">&copy; 2025 ZiZi. All rights reserved.</p>
  </div>
</footer>
